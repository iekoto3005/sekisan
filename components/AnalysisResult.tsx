...
const Placeholder = () => (
    <div className="text-center text-content-200">
        ...
        <p className="mt-4">画像の分析結果はここに表示されます。</p>
    </div>
);
  ...
  return (
    <div className="w-full min-h-[300px] h-full bg-base-200 border border-base-300 rounded-lg p-4 flex flex-col justify-center">
      {isLoading ? (
        ...
        <div className="prose prose-sm max-w-none text-content-100 whitespace-pre-wrap font-sans">
            {result}
        </div>
      ) : (
        <Placeholder />
